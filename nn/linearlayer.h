...
namespace NNModel {
    ...
    class LinearLayer : public NNLayerBase<RealVector, RealVector, RealVector, RealVector> {
    public:
        LinearLayer(double* parambase, double* gradbase, int inputsize, int outputsize);
        ~LinearLayer() {}
