...
class LccrfSamples {
    ...
    size_t GetMaxUnigramFeatureId() { return maxunifeatid_; }
    
    void SetMaxUnigramFeatureId(size_t val) { maxunifeatid_ = val; }
    
    size_t GetMaxBigramFeatureId() { return maxbifeatid_; }
    
    void SetMaxBigramFeatureId(size_t val) { maxbifeatid_ = val; }
    
    size_t NumSamples() const { return unigramfeatures_.size(); }
...
class LccrfLabels {
    ...
    std::vector<boost::shared_ptr<LabelVector>> &Labels() { return labels_; }
    
    boost::shared_ptr<LabelVector> &Labels(size_t idx) { return labels_[idx]; }
    
    size_t GetMaxLabelId() { return maxlabelid_; }
    
    size_t NumSamples() const { return labels_.size(); }
    
    void SetMaxLabelId(size_t val) { maxlabelid_ = val; }
