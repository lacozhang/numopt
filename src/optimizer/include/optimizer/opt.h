...
// header file for optimization algorithm like GD, SGD, CG, LBFGS, Proximal SGD,
// GD
...
public:
  ...
  OptMethodBase(ModelSpecType &model)
      : model_(model),
        basedesc_("General command line options for optimimizatioin method") {
  ...
  void SetTestData(boost::shared_ptr<DataIteratorType> dat) { testiter_ = dat; }

  inline int MaxIter() const { return learn_.maxiter_; }

  inline double LearningRate() const { return learn_.learningrate_; }

  inline double LearningRateDecay() const { return learn_.learningratedecay_; }

  inline double FunctionEpsilon() const { return learn_.funceps_; }

  inline double GradEpsilon() const { return learn_.gradeps_; }

  inline double L2RegVal() const { return learn_.l2_; }

  inline double L1RegVal() const { return learn_.l1_; }
...
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseL1RegOption = "l1";

template <class ParameterType, class SampleType, class LabelType,
          class SparseGradientType, class DenseGradientType>
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseL2RegOption = "l2";

template <class ParameterType, class SampleType, class LabelType,
          class SparseGradientType, class DenseGradientType>
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseMaxItersOption = "maxiter";

template <class ParameterType, class SampleType, class LabelType,
          class SparseGradientType, class DenseGradientType>
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseFunctionEpsOption = "feps";

template <class ParameterType, class SampleType, class LabelType,
          class SparseGradientType, class DenseGradientType>
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseGradEpsOption = "geps";

template <class ParameterType, class SampleType, class LabelType,
          class SparseGradientType, class DenseGradientType>
const char
    *OptMethodBase<ParameterType, SampleType, LabelType, SparseGradientType,
                   DenseGradientType>::kBaseMaxLineSearchTriesOption = "mlt";
#endif // __OPT_H__
