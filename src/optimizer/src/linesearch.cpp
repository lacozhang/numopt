...
LineSearcher::LineSearcher(const std::string &lsfuncstr,
                           const std::string &lscondstr, int maxtries,
                           float alpha, float beta, double minstep,
                           double maxstep, double parameps)
