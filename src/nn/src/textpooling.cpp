...
namespace NNModel {
    ...
    void TextMaxPoolingLayer::Forward(const RowRealMatrix & input, boost::shared_ptr<RealVector>& output) {
    ...
    void TextMaxPoolingLayer::InputGrad(const RowRealMatrix& input, const boost::shared_ptr<RealVector>& gradin, boost::shared_ptr<RowRealMatrix>& gradout) {
