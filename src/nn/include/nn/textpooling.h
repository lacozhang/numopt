...
namespace NNModel {
class TextMaxPoolingLayer
    : public NNLayerBase<RowRealMatrix, RealVector, RealVector, RowRealMatrix> {
public:
  typedef NNLayerBase<RowRealMatrix, RealVector, RealVector, RowRealMatrix>
      BaseType;
