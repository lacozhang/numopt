...
public:
  ...
  static boost::shared_ptr<Vocabulary>
  BuildVocabForQuery(const std::string &filepath, size_t cutoff,
                     bool hasbos = true, bool haseos = true);

  static boost::shared_ptr<Vocabulary>
  BuildVocabForLabel(const std::string &filepath);
